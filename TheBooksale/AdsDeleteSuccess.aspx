<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdsDeleteSuccess.aspx.cs" Inherits="TheBooksale.AdsDeleteSuccess" %>
...
<head runat="server">
    ...
    <title>The Booksale: Delete Success</title>
                ...
                <div class="col-md-12">
                    <div class="inner-box posting">
                        <div class="alert alert-success alert-lg" role="alert">
                            <h2 class="postin-title">✔ Your book ad has been successfully deactivated.</h2>
                        </div>
                    </div>
                </div>
            </div>
