<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdsDeleteConfirm.aspx.cs" Inherits="TheBooksale.AdsDeleteConfirm" %>
...
<head runat="server">
    ...
    <title>Delete Ad Confirmation</title>
                ...
                <div class="col-md-12">
                    <div class="inner-box posting">
                        <div class="alert alert-success alert-lg" role="alert">
                            <h2 class="postin-title">Are you sure you want to deactivate your book ad? Click OK to confirm.</h2>
                            <p><asp:Button ID="btnDeleteConfirm" runat="server" class="btn btn-danger btn-post" Text="Ok" OnClick="btnDeleteConfirm_Click"/></p>
                        </div>
                    </div>
                </div>
            </div>
