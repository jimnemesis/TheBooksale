<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="TheBooksale.Login" %>
...
<head runat="server">
    ...
    <title>Login to The Booksale</title>
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-4 col-md-4 col-md-offset-4">
                    <div class="page-login-form box">
                        ...
                        <form id="loginForm" role="form" class="login-form" data-toggle="validator" runat="server">
                            ...
                            <div class="checkbox">
                                <input type="checkbox" runat="server" id="chkRememberMe" name="rememberme" value="forever" style="float: left;" />
                                <label for="chkRememberMe">Remember me</label>
                            </div>
                            <asp:Button ID="btnLogin" runat="server" class="btn btn-common log-btn" Text="Submit" OnClick="btnLogin_Click" />
                            <div id="msgLogin" class="h3 text-center" runat="server"></div>
                            <div class="clearfix"></div>
                        </form>
                        <ul class="form-links">
                            <li class="pull-left"><a href="Signup.aspx">Don't have an account?</a></li>
                            <li class="pull-right"><a href="ForgotPassword.aspx">Forgot your password?</a></li>
                        </ul>
                    </div>
                </div>
            </div>
