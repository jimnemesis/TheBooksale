<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchResults.aspx.cs" Inherits="TheBooksale.SearchResults" %>
...
<body>
                                ...
                                <div class="input-group-addon search-category-container">
                                    <label class="styled-select">
                                        <asp:DropDownList ID="ddlCategories" runat="server" CssClass="dropdown-product selectpicker">
                                            <asp:ListItem Enabled="true" Selected="True" Text="All Categories" Value="All"></asp:ListItem>
                                        </asp:DropDownList>
                                    </label>
                                </div>
                            </div>
                                ...
                                <div class="input-group-addon search-category-container">
                                    <label class="styled-select location-select">
                                        <asp:DropDownList ID="ddlLocations" runat="server" CssClass="dropdown-product selectpicker">
                                            <asp:ListItem Enabled="true" Selected="True" Text="All Locations" Value="All"></asp:ListItem>
                                        </asp:DropDownList>
                                    </label>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-9 page-content">
                        ...
                        <div class="product-filter">
                            <div class="Show-item">
                                ...
                                <label class="control-label text-left">
                                    <asp:Label ID="lblSearchKeyword" runat="server" Text="''"></asp:Label>
                                </label>
                            </div>
                            <div class="Show-item">
                                <span>Filter: </span>
                        ...
                        <!-- Ads wrapper Start -->
                        <asp:ListView ID="lvwSearchItems" runat="server" ItemPlaceholderID="plhSearchItems">
                            <LayoutTemplate>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered add-manage-table">
                                        <tbody>
                                            <asp:PlaceHolder ID="plhSearchItems" runat="server"></asp:PlaceHolder>
                                        </tbody>
                                    </table>
                                </div>
                            </LayoutTemplate>
                        ...
                        <div class="pager">
                            <asp:DataPager ID="pgrSearchItems" runat="server" PagedControlID="lvwSearchItems" PageSize="5">
                                <Fields>
    ...
    <asp:SqlDataSource ID="sqlSearchItems" runat="server" ConnectionString="<%$ ConnectionStrings:cnBooksale %>" ProviderName="<%$ ConnectionStrings:cnBooksale.ProviderName %>"></asp:SqlDataSource>
