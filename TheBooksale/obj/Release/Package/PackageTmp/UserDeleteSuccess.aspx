<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserDeleteSuccess.aspx.cs" Inherits="TheBooksale.UserDeleteSuccess" %>
...
<head runat="server">
    ...
    <title>Close Account Success</title>
                ...
                <div class="col-md-12">
                    <div class="inner-box posting">
                        <div class="alert alert-success alert-lg" role="alert">
                            <h2 class="postin-title">✔ Your account has been successfully closed.</h2>
                            <p>We're sad to see you go. We hope to be of service to you again soon.</p>
                        </div>
                    </div>
                </div>
            </div>
