<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAds.aspx.cs" Inherits="TheBooksale.UserAds" %>
...
<head runat="server">
    ...
    <title>The Booksale: My Ads</title>
                            ...
                            <div class="user-panel-sidebar">
                                ...
                                <div class="collapse-box">
                                    ...
                                    <div aria-expanded="true" id="myads" class="panel-collapse collapse in">
                                        <ul id="ulMyAds" runat="server" class="acc-list">
                                            <li id="liAllMyAds" runat="server">
                                                <a href="UserAds.aspx?XLM=0"><i class="fa fa-credit-card"></i> All My Ads </a>
                                            </li>
                        <li id="liPublishedAds" runat="server">
                          <a href="UserAds.aspx?XLM=1"><i class="fa fa-star-o"></i> Published </a>
                        </li>
                                            <li id="liPendingAds" runat="server">
                        ...
                        <asp:Label ID="lblCategory" runat="server" Text='<%# Eval("CAT_CATEGORY_NAME") %>'></asp:Label>
                          ...
                          <p> <strong>Status:</strong> 
                              <asp:Label ID="lblStatus" runat="server" Text='<%# Eval("STA_STATUS_NAME") %>'></asp:Label>
                                        ...
                                        <td class="action-td">
                                            <p><a class="btn btn-primary btn-xs" href='<%# "AdsUpdate.aspx?XME=1&XAD=" + Eval("ADS_ID") %>'><i class="fa fa-pencil-square-o"></i>Edit</a></p>
                                            <p><a class="btn btn-danger btn-xs" href='<%# "AdsUpdate.aspx?XME=2&XAD=" + Eval("ADS_ID") %>'><i class=" fa fa-trash"></i>Deactivate</a></p>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                        </asp:ListView>
<div class="pager">
                            <asp:DataPager ID="pgrSearchItems" runat="server" PagedControlID="lvwMyAds" PageSize="5">
                                <Fields>
