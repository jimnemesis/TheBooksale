<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="TheBooksale.SignUp" %>
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
                    <div class="page-login-form box">
                        ...
                        <form id="signupForm" role="form" class="login-form" data-toggle="validator" runat="server">
                            ...
                            <div class="form-group">
                                <div class="input-icon">
                                    ...
                                    <asp:TextBox ID="txtEmail" TextMode="Email" runat="server" class="form-control" placeholder="Email Address"></asp:TextBox>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="input-icon">
                                    ...
                                    <asp:TextBox ID="txtPhone" TextMode="Phone" runat="server" class="form-control" placeholder="PH Contact Number"></asp:TextBox>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="checkbox">
                                ...
                                <label for="chkAgree">By creating an account, you acknowledge that you have read 
                                    ...
                                    and <a href="InfoPrivacy.aspx" target="_blank">Privacy Policy</a></label>
                            </div>
                            <asp:Button ID="btnSignUp" runat="server" class="btn btn-common log-btn" Text="Sign Up" OnClick="btnSignUp_Click" OnClientClick="if (!checkAgree()) return false; " />
                        </form>
                    </div>
                </div>
            </div>
...
<asp:ListView ID="lvwLatestAds" runat="server">
    ...
    <asp:SqlDataSource ID="sqlUserProfile" runat="server" InsertCommand="insert into dbo.usr_profiles
(usr_profile_id, usr_lastname, usr_firstname, usr_email, usr_phone, usr_daterequest)
values
(@prmUsrProfId, @prmLName, @prmFName, @prmEmail, @prmPhone, getdate())"
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="prmEmail" />
            <asp:Parameter Name="prmDisplayName" />
            <asp:Parameter Name="prmPhone" />
            <asp:Parameter Name="prmBirthDate" />
    ...
    <asp:SqlDataSource ID="sqlUser" runat="server" InsertCommand="insert into dbo.usr_users
(usr_user_id, usr_username, usr_password, usr_profile_id, rol_role_id, usr_active, usr_remarks, usr_date_created, usr_date_updated)
values
(@prmUserId, @prmUserName, @prmPwd, @prmUsrProfId, 1, 1, '', getdate(), getdate())"
        ConnectionString="<%$ ConnectionStrings:cnBooksale %>" ProviderName="<%$ ConnectionStrings:cnBooksale.ProviderName %>">
        <InsertParameters>
            <asp:Parameter Name="prmUserId" />
            <asp:Parameter Name="prmUserName" />
