<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdsUpdate.aspx.cs" Inherits="TheBooksale.AdsUpdate" %>
                ...
                <div class="col-sm-12 col-md-10 col-md-offset-1">
                    <form id="PostForm" runat="server">
                        <div class="page-ads box">
                            <h2 class="title-2">Update Your Book Ad</h2>
                            <!-- Start Search box -->
                                        ...
                                        <div class="col-md-4 col-sm-12 search-col">
                                            <div class="input-group-addon search-category-container">
                                                <label class="styled-select default-select">
                                                    ...
                                                    <asp:DropDownList ID="ddlCategories" runat="server" CssClass="dropdown-product selectpicker" AutoPostBack="True" OnSelectedIndexChanged="ddlCategories_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </label>
                                            </div>
                                        </div>
                                ...
                                <div class="advanced-search">
                                    <div class="search-form">
                                        ...
                                        <div class="col-md-4 col-sm-12 search-col">
                                            <div class="input-group-addon search-category-container">
                                                <label class="styled-select default-select">
                                                    <span class="hidden-sm hidden-xs">Status </span>
                                                    <asp:DropDownList ID="ddlStatus" runat="server" CssClass="dropdown-product selectpicker">
                                                    </asp:DropDownList>
                                                </label>
                                            </div>
                                        </div>
                            ...
                            <div class="form-ad">
                                ...
                                <h2 class="title-2">Replace the Images In Your Ad</h2>
...
<div id="divOwlDemo" runat="server">
                                ...
                                <div id="divImages" runat="server" class="form-group">
                        ...
                        <div class="form-group">
                            <div class="page-ads box">
                                ...
                                <br />
                                <asp:Button ID="btnSubmit" runat="server" class="btn btn-common" Text="Resubmit for Review" OnClientClick="if (!checkAgree()) return false; " OnClick="btnSubmit_Click" />
                            </div>
                        </div>
                    </form>
                </div>
...
<asp:SqlDataSource ID="sqlLatestAds" runat="server" ConnectionString="<%$ ConnectionStrings:cnBooksale %>" ProviderName="<%$ ConnectionStrings:cnBooksale.ProviderName %>"></asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="sqlAdsMain" runat="server"
        ConnectionString="<%$ ConnectionStrings:cnBooksale %>" ProviderName="<%$ ConnectionStrings:cnBooksale.ProviderName %>" UpdateCommand="update dbo.ads_bookads
set adt_adtype_id = @prmAdTypeId, 
	sub_subcategory_id = @prmSubCategoryId, 
	con_condition_id = @prmConditionId, 
	ads_price = @prmPrice, 
	ads_title = @prmTitle, 
	ads_description = @prmDescription, 
	ads_negotiable = @prmNegotiable, 
	sta_status_id = @prmStatus, 
	ads_modifieddate = GetDate()
where ads_id = @prmAdsId">
        <UpdateParameters>
...
values (@prmAdDetailsId, @prmAdsid, @prmAuthorId, @prmAuthorName, null)"
        ConnectionString="<%$ ConnectionStrings:cnBooksale %>" ProviderName="<%$ ConnectionStrings:cnBooksale.ProviderName %>" UpdateCommand="update dbo.ads_bookads_details
set aut_author_id = @prmAuthorId, 
add_author_name = @prmAuthorName
where ads_id = @prmAdsId">
        <InsertParameters>
...
values (@prmPhotoId, @prmCaption, @prmPath, @prmOrder)"
        ConnectionString="<%$ ConnectionStrings:cnBooksale %>" ProviderName="<%$ ConnectionStrings:cnBooksale.ProviderName %>" UpdateCommand="update pho_photos
set pho_caption = @prmCaption, 
	pho_path = @prmPath
where pho_photo_id = @prmPhotoId
and pho_order = @prmOrder">
        <InsertParameters>
            <asp:Parameter Name="prmPhotoId" />
