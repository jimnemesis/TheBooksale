<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPasswordSuccess.aspx.cs" Inherits="TheBooksale.ForgotPasswordSuccess" %>
                ...
                <div class="col-md-12">
                    <div class="inner-box posting">
                        <div class="alert alert-success alert-lg" role="alert">
                            <h2 class="postin-title">✔ Your password has been sent to your registered email.</h2>
                        </div>
                    </div>
                </div>
            </div>
