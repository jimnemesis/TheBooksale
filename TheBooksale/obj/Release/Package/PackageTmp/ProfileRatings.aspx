<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProfileRatings.aspx.cs" Inherits="TheBooksale.ProfileRatings" %>
                ...
                <div class="col-sm-9 page-content">
                    ...
                    <div class="inner-box">
                        <h2 class="title-2"><i id="itaListHeader" runat="server"></i>
                            <asp:Label ID="lblListHeader" runat="server" Text="My Ratings"></asp:Label></h2>
                  ...
                  <tbody>
                        <asp:ListView ID="lvwReviews" runat="server">
                            <ItemTemplate>
                    <tr>
                      <td class="ads-details-td">
                        <h4>
                            <asp:Label ID="lblRating" runat="server" Text='<%# Eval("RVW_RATE") + " Star(s) "%>'></asp:Label></a></h4>
                        <p> <strong> Review By </strong>:
                            <a id="lnkViaName" runat="server" 
                                href='<%# ((int)Eval("RVW_TYPE") == 2) ? "ReviewForBuyer.aspx?XID=" + Eval("USR_USER_ID_RVW") : "ReviewForSeller.aspx?XAD=&XID=" + Eval("USR_USER_ID_RVW") %>'>
                        <asp:Label ID="lblReviewer" runat="server" Text='<%# Eval("USR_FIRSTNAME_RVW") + " " + Eval("USR_LASTNAME_RVW") %>'></asp:Label>
                                </a>
                        </p>
                          <p> <strong> Review </strong>:
                        <asp:Label ID="lblReview" runat="server" Text='<%# Eval("RVW_REVIEW") %>'></asp:Label>
                        </p>
                      </td>
                    </tr>
                            </ItemTemplate>
