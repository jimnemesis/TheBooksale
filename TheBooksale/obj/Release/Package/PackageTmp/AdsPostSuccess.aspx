<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdsPostSuccess.aspx.cs" Inherits="TheBooksale.AdsPostSuccess" %>
                ...
                <div class="col-md-12">
                    <div class="inner-box posting">
                        <div class="alert alert-success alert-lg" role="alert">
                            <h2 class="postin-title">✔ Your book ad will be available soon.</h2>
                            <p>After a successful review, you should receive an e-mail notification once your book ad has been published.</p>
                        </div>
                    </div>
                </div>
            </div>
