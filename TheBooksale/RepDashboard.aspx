<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepDashboard.aspx.cs" Inherits="TheBooksale.RepDashboard" %>
            ...
            <div class="row">
                <div class="col-md-2 col-sm-6 col-xs-12">
                    <div class="counting wow fadeInDownQuick" data-wow-delay=".5s">
                        ...
                        <div class="desc">
                            <h3 class="counter">
                                <asp:Label ID="lblCtrMyAdsTotal" runat="server" Text="Label"></asp:Label>
                            </h3>
                            <p>My Book Ads</p>
                        </div>
                    </div>
                ...
                <div class="col-md-2 col-sm-6 col-xs-12">
                    <div class="counting wow fadeInDownQuick" data-wow-delay="1s">
                        ...
                        <div class="desc">
                            <h3 class="counter">
                                <asp:Label ID="lblCtrMyAdsViewsTotal" runat="server" Text="Label"></asp:Label>
                            </h3>
                            <p>My Ads' Views</p>
                        </div>
                    </div>
                ...
                <div class="col-md-2 col-sm-6 col-xs-12">
                    <div class="counting wow fadeInDownQuick" data-wow-delay="1.5s">
                        ...
                        <div class="desc">
                            <h3 class="counter">
                                <asp:Label ID="lblCtrMyReviewsForMe" runat="server" Text="Label"></asp:Label>
                            </h3>
                ...
                <div class="col-md-2 col-sm-6 col-xs-12">
                    <div class="counting wow fadeInDownQuick" data-wow-delay="2s">
                        ...
                        <div class="desc">
                            <h3 class="counter">
                                <asp:Label ID="lblCtrMyReviewsByMe" runat="server" Text="Label"></asp:Label>
                            </h3>
                            <p>Reviews Made</p>
                        </div>
                    </div>
                ...
                <div class="col-md-2 col-sm-6 col-xs-12">
                    <div class="counting wow fadeInDownQuick" data-wow-delay="2.5s">
                        <div class="icon">
                            <span>
                        ...
                        <div class="desc">
                            <h3 class="counter">
                                <asp:Label ID="lblCtrMyAdsReserved" runat="server" Text="Label"></asp:Label>
                            </h3>
                            <p>Book Ads Reserved</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-2 col-sm-6 col-xs-12">
                    <div class="counting wow fadeInDownQuick" data-wow-delay="3s">
                        <div class="icon">
                            <span>
                        ...
                        <div class="desc">
                            <h3 class="counter">
                                <asp:Label ID="lblCtrMyAdsSold" runat="server" Text="Label"></asp:Label>
                            </h3>
                            <p>Book Ads Sold</p>
                        </div>
                    </div>
