<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReviewSuccess.aspx.cs" Inherits="TheBooksale.ReviewSuccess" %>
...
<head runat="server">
    ...
    <title>The Booksale: Review</title>
                ...
                <div class="col-md-12">
                    <div class="inner-box posting">
                        <div class="alert alert-success alert-lg" role="alert">
                            <h2 class="postin-title">✔ Your review will be available soon.</h2>
                            <p>After a successful check, you should receive an e-mail notification once your review has been published.</p>
                        </div>
                    </div>
                </div>
            </div>
