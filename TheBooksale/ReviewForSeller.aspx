<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReviewForSeller.aspx.cs" Inherits="TheBooksale.ReviewForSeller" %>
                ...
                <div class="col-sm-12 col-md-10 col-md-offset-1">
                    <form id="PostForm" runat="server">
                        <div class="page-ads box">
                            <h2 class="title-2">Rate "<asp:Label ID="lblSellerName" runat="server" Text="Label"></asp:Label>" as a Seller</h2>
                            <!-- Start Search box -->
...
values (@prmRvwId, @prmUserId, @prmRvwForUserId, @prmRate, @prmReview, GetDate(), 1, 2)"
