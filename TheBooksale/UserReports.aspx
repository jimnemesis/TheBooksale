<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserReports.aspx.cs" Inherits="TheBooksale.UserReports" %>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box-title no-border">
                <div class="inner">
                  <h3 class="section-title"><span>View the</span> Reports</h3>   
                </div>
              </div>
            </div>
<div class="col-md-12">              
              <div class="col-md-2 col-sm-3 col-xs-6 f-category wow fadeIn" data-wow-delay="0s">
                <a id="lnkReportDashboard" runat="server" href="RepDashboard.aspx">
                  <div class="icon">
              ...
              <div class="col-md-2 col-sm-3 col-xs-6 f-category wow fadeIn" data-wow-delay="0.2s">
                <a id="lnkReportAds" runat="server" href="ProfileRatings.aspx">
                  <div class="icon">
                    <i class="fa fa-laptop"></i>
                  </div>
                  <h6>My Ads and Reviews</h6> 
                </a>
              </div>
              <div class="col-md-2 col-sm-3 col-xs-6 f-category wow fadeIn" data-wow-delay="0.4s">
                <a id="lnkReportOffers" runat="server" href="RepOffers.aspx?XCA=0">
                  <div class="icon">
