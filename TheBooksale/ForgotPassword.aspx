<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="TheBooksale.ForgotPassword" %>
...
<head runat="server">
    ...
    <title>The Booksale: Forgot Password</title>
                        ...
                        <form role="form" runat="server" class="login-form">
                            <div class="form-group">
                                <div class="input-icon">
                                    ...
                                    <asp:TextBox ID="txtEmailPhone" runat="server" class="form-control" placeholder="Enter your Email or Phone"></asp:TextBox>
                                </div>
                            </div>
                            <asp:Button ID="btnSendPwd" runat="server" class="btn btn-common log-btn" Text="Send me my Password" OnClick="btnSendPwd_Click" />
                            <div id="msgPassword" class="h3 text-center" runat="server"></div>
                        </form>
                        <ul class="form-links">
                            <li class="pull-left"><a href="SignUp.aspx">Don't have an account?</a></li>
                            <li class="pull-right"><a href="Login.aspx">Back to Login</a></li>
                        </ul>
                    </div>
                </div>
            </div>
