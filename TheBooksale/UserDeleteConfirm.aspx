<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserDeleteConfirm.aspx.cs" Inherits="TheBooksale.UserDeleteConfirm" %>
...
<head runat="server">
    ...
    <title>Close Account Confirmation</title>
                ...
                <div class="col-md-12">
                    <div class="inner-box posting">
                        <div class="alert alert-success alert-lg" role="alert">
                            <h2 class="postin-title">Do you really want to close your account?<br /> 
                                If it's closed, you'll no longer be able to find great books on The Booksale. 
                                <br />Click OK to confirm.</h2>
